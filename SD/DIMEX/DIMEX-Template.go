...
func (module *DIMEX_Module) handleUponReqEntry() {
	...
	*/
	...
	module.nbrResps = 0
	for id, address := range module.addresses {
		if id != module.id {
			module.sendToLink(address, "reqEntry,"+strconv.Itoa(module.id)+","+strconv.Itoa(module.reqTs), module.addresses[module.id])
		}
	}
	module.st = wantMX
}
...
func (module *DIMEX_Module) handleUponReqExit() {
	/*
						upon event [ dmx, Exit  |  r  ]  do
		    				...
		    				estado := naoQueroSC
	*/
	for id := range module.waiting {
		if module.waiting[id] == true {
			module.sendToLink(module.addresses[id], "respOK", module.addresses[module.id])
		}
	}
...
func (module *DIMEX_Module) handleUponDeliverRespOk(msgOutro PP2PLink.PP2PLink_Ind_Message) {
	...
	*/
	...
	//fmt.Println(module.nbrResps)
	if module.nbrResps == 2 {
		module.Ind <- dmxResp{}
		module.st = inMX
	}
}
...
func (module *DIMEX_Module) handleUponDeliverReqEntry(msgOutro PP2PLink.PP2PLink_Ind_Message) {
	...
	*/
	...
	msgSplit := strings.Split(msgOutro.Message, ",")
	origin_id, _ := strconv.Atoi(msgSplit[1])
	origin_ts, _ := strconv.Atoi(msgSplit[2])

	fmt.Println(module.waiting)
	if (module.st == noMX) || (module.st == wantMX && after(module.id, module.reqTs, origin_id, origin_ts)) {
		module.sendToLink(module.addresses[origin_id], "respOK", module.addresses[module.id])
	} else {
		module.waiting[origin_id] = true
	}
	module.lcl = max(module.lcl, origin_ts)
